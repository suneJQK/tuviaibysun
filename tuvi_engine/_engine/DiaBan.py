...
class cungDiaBan(object):
    ...
    def __init__(self, cungID, canDiaBan = None):
        ...
        self.cungHanh = diaChi[self.cungSo]["tenHanh"]
        self.cungThan = False
...
class diaBan(object):
    ...
    def cungChu(self, thangSinhAmLich, gioSinhAmLich):
        ...
        cungChuThapNhiCung = [
            {"cungId": 1, "tenCung": "Mệnh", "cungSoDiaBan": self.cungMenh},
            ...
            {"cungId": 6, "tenCung": "Nô bộc", "cungSoDiaBan": self.cungNoboc},
...
def dacTinhSao(viTriDiaBan, sao):
    maTranDacTinh = {
        1: [
            "Tử vi",
            "B", "Đ", "M", "B", "V", "M", "M", "Đ", "M", "B", "V", "B"
        ],
        2: [
            "Liêm trinh",
            "V", "Đ", "V", "H", "M", "H", "V", "Đ", "V", "H", "M", "H"
        ],
        3: [
            "Thiên đồng",
            "V", "H", "M", "Đ", "H", "Đ", "H", "H", "M", "H", "H", "Đ"
        ],
        4: [
            "Vũ khúc",
            "V", "M", "V", "Đ", "M", "H", "V", "M", "V", "Đ", "M", "H"
        ],
        5: [
            "Thái dương",
            "H", "Đ", "V", "V", "V", "M", "M", "Đ", "H", "H", "H", "H"
        ],
        6: [
            "Thiên cơ",
            "Đ", "Đ", "H", "M", "M", "V", "Đ", "Đ", "V", "M", "M", "H"
        ],
        7: [
            "Thiên phủ",
            "M", "B", "M", "B", "V", "Đ", "M", "Đ", "M", "B", "V", "Đ"
        ],
        8: [
            "Thái âm",
            "V", "Đ", "H", "H", "H", "H", "H", "Đ", "V", "M", "M", "M"
        ],
        9: [
            "Tham lang",
            "H", "M", "Đ", "H", "V", "H", "H", "M", "Đ", "H", "V", "H"
        ],
        10: [
            "Cự môn",
            "V", "H", "V", "M", "H", "H", "V", "H", "Đ", "M", "H", "Đ"
        ],
        11: [
            "Thiên tướng",
            "V", "Đ", "M", "H", "V", "Đ", "V", "Đ", "M", "H", "V", "Đ"
        ],
        12: [
            "Thiên lương",
            "Đ", "Đ", "V", "V", "M", "H", "M", "Đ", "V", "H", "M", "H"
        ],
        13: [
            "Thất sát",
            "M", "Đ", "M", "H", "H", "V", "M", "Đ", "M", "H", "H", "H"
        ],
        14: [
            "Phá quân",
            "M", "V", "H", "H", "V", "H", "M", "V", "H", "H", "V", "H"
        ],
        51: [
            "Đà la",
            "H", "Đ", "H", "H", "Đ", "H", "H", "Đ", "H", "H", "Đ", "H"
        ],
        52: [
            "Kình dương",
            "H", "Đ", "H", "H", "Đ", "H", "H", "Đ", "H", "H", "Đ", "H"
